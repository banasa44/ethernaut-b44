...
contract("GatekeeperOne", (accounts) => {
  ...
  it("should craft the correct gateKey and pass all gates", async () => {
    ...
    const txOrigin = accounts[2]; // Replace with your EOA if testing differently
    ...
    console.log("Crafted gateKey:", accounts[2]);
    ...
    for (let i = 0; i < 500; i++) {
      const gasAmount = 8191 * 4 + i; // Slightly adjust gas
      try {
